...
import static org.apache.shiro.codec.Hex.*;
...
public final class EndecryptUtils {
    ...
    public static  boolean checkMd5Password(String username,String password,String salt,String md5cipherText)
    {
        ...
        public static void main(String[] args) {
           ...
           User user =  md5Password("admin","admin");


            System.out.println(checkMd5Password(user.getUsername(),"admin",user.getSalt(),user.getPassword())) ;
          /*  String password = "admin";
            ...
            String aes_mingwen=new String(aesCipherService.decrypt(decode(aes_cipherText),key.getEncoded()).getBytes());
            System.out.println(aes_cipherText+" aes解密的明文是："+aes_mingwen);*/
//            System.out.println(checkMd5Password("admin","4rsHJeFpCCAeQ9R6gRoqjA==","1c42ce024681443e231f3e89d3bfc557","4rsHJeFpCCAeQ9R6gRoqjA=="));
        }
    }
